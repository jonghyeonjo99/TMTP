...
import com.example.pillinfo.repository.PillInfoRepository;
...
public class Homecontroller {
    @Autowired
    private PillInfoRepository infoRepository;
        ...
        try {
            for(int i = 1; i < 85; i++) {
                ...
                for(int j = 0; j < items.size(); j++) {
                    ...
                    Pill pillObj = new Pill((j+(long)1)+(300*i),String.valueOf(tmp.get("ITEM_SEQ")),String.valueOf(tmp.get("ITEM_NAME")),String.valueOf(tmp.get("ITEM_IMAGE")),String.valueOf(tmp.get("PRINT_FRONT")),String.valueOf(tmp.get("PRINT_BACK")),String.valueOf(tmp.get("DRUG_SHAPE")),
