package com.example.pill_info.configuration;
...
@EnableJpaRepositories(
        basePackages = "com.example.pill_info.repository", // TODO Repository 패키지 지정
...
public class DBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder.dataSource(dataSource)
                .packages("com.example.pill_info.model") // TODO Model 패키지 지정
                .properties(map)
                .build();
    }
