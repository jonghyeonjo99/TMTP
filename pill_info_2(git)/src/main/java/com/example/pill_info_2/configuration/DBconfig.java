package com.example.pill_info_2.configuration;
...
@EnableJpaRepositories(
        basePackages = "com.example.pill_info_2.repository", // TODO Repository 패키지 지정
...
public class DBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder.dataSource(dataSource)
                .packages("com.example.pill_info_2.model") // TODO Model 패키지 지정
                .properties(map)
                .build();
    }
